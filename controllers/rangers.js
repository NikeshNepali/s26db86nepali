...
exports.ranger_create_Page = function(req, res) {
console.log("create view")
try{
res.render('rangerCreate', { title: 'Ranger Create'});
}
catch(err){
res.status(500)
res.send(`{'error': '${err}'}`);
...
exports.ranger_update_Page = async function(req, res) {
console.log("update view for item "+req.query.id)
try{
let result = await rangers.findById(req.query.id)
res.render('rangerUpdate', { title: 'Ranger Update', toShow: result });
}
catch(err){
res.status(500)
res.send(`{'error': '${err}'}`);
...
exports.ranger_delete_Page = async function(req, res) {
console.log("Delete view for id " + req.query.id)
try{
result = await rangers.findById(req.query.id)
res.render('rangerDelete', { title: 'Ranger Delete', toShow:
result });
}
catch(err){
res.status(500)
